...
namespace SI.Infrastructure.Integrations.SimpleStorage;

public class SIService : ISimpleStorage
{
    private readonly IMinioClient _s3Client;
    private readonly ILogger<SIService> _logger;
    private readonly string _baseResUrl;
    private readonly IConfiguration _configuration;

    public SIService(
        ILogger<SIService> logger,
