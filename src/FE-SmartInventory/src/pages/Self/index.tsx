            ...
            <Card bordered={false} className="h-full shadow-sm">
              <div className="py-auto text-center">
                ...
                <p className="font-medium text-base flex items-center justify-center gap-2">
                  {selfInfo?.data.unitName} <RoleTag role={role as RoleEnumString} />
                </p>
          ...
          <Col xs={24} lg={16}>
            <Card title="Thông tin tài khoản" bordered={false} className="shadow-sm">
              <Descriptions layout="horizontal" column={1} bordered size="small">
                ...
                <Descriptions.Item label="Đơn Vị">{selfInfo?.data.unitName}</Descriptions.Item>

                <Descriptions.Item label="Mã Người Dùng">{selfInfo?.data.userId}</Descriptions.Item>
                <Descriptions.Item label="Mã Đơn Vị">{selfInfo?.data.unitId}</Descriptions.Item>
              </Descriptions>
            </Card>
          </Col>
        </Row>
